...
const AddOnProducteRouter = require('./router/addOnProductRouter')
...
const customersByMobileNumberRouter = require('./router/customerByMobileNumberRouter')
...
const getKOTrunningRouter = require('./router/KOTrunningRouter')
...
app.use('/KOTrunning', getKOTrunningRouter)
...
app.use('/AddOnProduct', AddOnProducteRouter)
...
app.use('/customersByMobileNumber', customersByMobileNumberRouter)
